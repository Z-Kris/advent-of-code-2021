...
object Day11 : Puzzle<OctupusGrid, Int>(11) {
    ...
    override fun OctupusGrid.solvePartTwo() = DumboOctupuses(list.toMutableList(), dimension).firstOccurrenceOfFullyLitGrid()
}
...
data class OctupusGrid(val list: List<Int>, val dimension: Int)
